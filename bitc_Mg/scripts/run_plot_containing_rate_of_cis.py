...
if len(mcmc_trace_files)>0:
    ...
    plot_containing_rates([LEVELS_PERCENT], [b_rates],
                            ...
                            xlabel=XLABEL+' '+args.parameter,
                            ylabel=YLABEL+' '+args.parameter,
                            xlimits=[0, 100], ylimits=[0, 100], out=out)


# nonlinear ls cis
if len(args.nonlinear_fit_result_file)>0 and os.path.exists(args.nonlinear_fit_result_file):
    ...
    try: 
        ...
        out = args.parameter + "_nls.pdf"
        plot_containing_rates([LEVELS_PERCENT], [g_rates], out=out,
        ...
        pickle.dump({"LEVELS_PERCENT":LEVELS_PERCENT, "g_rates":g_rates},
                    open(args.parameter + "_nls.pkl", "wb"))
