...
from _kde_kullback_leibler_divergence import plot_triple_of_annotated_heatmap, numerical_kl_div

parser = argparse.ArgumentParser()

parser.add_argument( "--lognorP0_lognorLs_kde_dir",              type=str, default="lognomP0_lognomLs")
parser.add_argument( "--unifP0_lognorLs_kde_dir",              type=str, default="unifP0_lognomLs")
...
kld_matrix_lognorP0_lognorLs   = _kld_matrix(args.lognorP0_lognorLs_kde_dir, ordered_experiment_names)

kld_matrix_unifP0_lognorLs   = _kld_matrix(args.unifP0_lognorLs_kde_dir, ordered_experiment_names)

kld_matrix_nonlin = _kld_matrix(args.nonlinear_kde_dir, ordered_experiment_names)

kld_matrix_lognorP0_lognorLs = np.log(kld_matrix_lognorP0_lognorLs)
kld_matrix_lognorP0_lognorLs[kld_matrix_lognorP0_lognorLs == -np.inf] = 1.

kld_matrix_unifP0_lognorLs = np.log(kld_matrix_unifP0_lognorLs)
kld_matrix_unifP0_lognorLs[kld_matrix_unifP0_lognorLs == -np.inf] = 1.

kld_matrix_nonlin = np.log(kld_matrix_nonlin)
kld_matrix_nonlin[kld_matrix_nonlin == -np.inf] = 1.


plot_triple_of_annotated_heatmap(kld_matrix_lognorP0_lognorLs, kld_matrix_unifP0_lognorLs, kld_matrix_nonlin, args.out)
