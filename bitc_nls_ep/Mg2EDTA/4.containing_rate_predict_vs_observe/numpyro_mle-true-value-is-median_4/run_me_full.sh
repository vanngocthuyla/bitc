...
export NLS="/Users/seneysophie/Work/Python/Local/bitc_nls_ep/Mg2EDTA/3.nls/MLE_4_parameters.csv"

export EP="/Users/seneysophie/Work/Python/Local/bitc_nls_ep/Mg2EDTA/3.nls/Propagation_4_parameters.csv"
...
python $SCRIPT --bitc_mcmc_dir $MCMC --nonlinear_fit_result_file $NLS --propagation_error_result_file $EP --central $CENTRAL --ordered_experiment_names_1 "$EXPE1" --ordered_experiment_names_2 "$EXPE2" --parameter "DeltaG DeltaH DeltaH_0 P0"
