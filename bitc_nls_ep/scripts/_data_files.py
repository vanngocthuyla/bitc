...
def read_experimental_design_parameters(file_name):
    ...
    return
        parameters  : dict of parameters[exper_name] -> {"syringe_concentration":float, ...}
    """
    parameters = {}
...
def write_dummy_itc_file(experimental_design_parameters, out_file_name, 
                         number_of_injections=None, target_temperature=25,
                         equilibration_time=180, reference_power=5, 
                         injection_duration=3, filter_period=5, cell_volume=1.434,
                         bottom = "# 25\n# 3.649\n# 9.80219\n?\n"):
    """
    """
